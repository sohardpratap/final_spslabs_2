...
import { ArrowRight, Zap, Shield, FileText, QrCode, Sparkles, Bot, Building2 } from 'lucide-react';
...
const Home: React.FC = () => {
  const featuredProducts = [
    ...
    },
    {
      id: 'logify',
      name: 'Logify',
      description: 'Export Your Chats, Effortlessly!',
      icon: FileText,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {featuredProducts.map((product, index) => {
              ...
              return (
                <div
                  key={product.id}
                  className="group bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-800 overflow-hidden"
                >
                  <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-800"
                >
                  <div className="flex items-center justify-center mb-6">
